...
#> ℹ Cache directory: /tmp/RtmpemnIbk/mapSpain.

# Set an example cache.
ex <- file.path(tempdir(), "example", "cachenew")
esp_set_cache_dir(ex)
#> ℹ mapSpain cache directory is /tmp/RtmpemnIbk/example/cachenew.
#> ℹ To install your `cache_dir` path for use in future sessions, run this function with `install` set to "TRUE".

esp_detect_cache_dir()
#> ℹ Cache directory: /tmp/RtmpemnIbk/example/cachenew.
#> [1] "/tmp/RtmpemnIbk/example/cachenew"

# Restore the initial cache.
esp_set_cache_dir(my_cache)
#> ℹ mapSpain cache directory is /tmp/RtmpemnIbk/mapSpain.
#> ℹ To install your `cache_dir` path for use in future sessions, run this function with `install` set to "TRUE".
