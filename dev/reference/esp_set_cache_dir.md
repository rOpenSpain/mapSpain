...
#> ℹ C:\Users\RUNNER~1\AppData\Local\Temp\Rtmp65IhWV/mapSpain

# Set an example cache
ex <- file.path(tempdir(), "example", "cachenew")
esp_set_cache_dir(ex)
#> ℹ mapSpain cache dir is C:\Users\RUNNER~1\AppData\Local\Temp\Rtmp65IhWV/example/cachenew.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.

esp_detect_cache_dir()
#> ℹ C:\Users\RUNNER~1\AppData\Local\Temp\Rtmp65IhWV/example/cachenew
#> [1] "C:\\Users\\RUNNER~1\\AppData\\Local\\Temp\\Rtmp65IhWV/example/cachenew"

# Restore initial cache
esp_set_cache_dir(my_cache)
#> ℹ mapSpain cache dir is C:\Users\RUNNER~1\AppData\Local\Temp\Rtmp65IhWV/mapSpain.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.
...
esp_detect_cache_dir()
#> ℹ C:\Users\RUNNER~1\AppData\Local\Temp\Rtmp65IhWV/mapSpain
#> [1] "C:\\Users\\RUNNER~1\\AppData\\Local\\Temp\\Rtmp65IhWV/mapSpain"
```
