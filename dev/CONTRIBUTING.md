...
This guide explains how to propose a change to **mapSpain**. Review the
...
- Fork the package and clone it onto your computer. If you have not done
  this before, use
  `usethis::create_from_github("rOpenSpain/mapSpain", fork = TRUE)`.
...
Please note that the **mapSpain** project is released with a
[Contributor Code of
Conduct](https://ropenspain.github.io/mapSpain/dev/CODE_OF_CONDUCT.md).
