...
Atlas Nacional de España (ANE) [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/deed.en) [ign.es](http://www.ign.es).
...
A `zip` file ([dist/CartoBase.zip](dist/CartoBase.zip), `r format(size, units = "auto")` ) is also provided, including all the data on `dist`.
