...
providers you can use on functions described above. This list includes all
the parameters needed to replicate the API request. See the static url of each
provider:
