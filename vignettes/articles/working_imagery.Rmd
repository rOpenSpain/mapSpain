...
```{r}
#| label: static1
#| fig-alt: Map of the limits of city of Logroño using a tile as a basemap
library(mapSpain)
library(sf)
library(ggplot2)
library(tidyterra)
...
```{r}
#| label: static2
#| fig-alt: Map of the roads of Autonomous Communities surrouding Madrid
...
```{r}
#| label: static_transp
#| fig-alt: Example on how to use alpha value for combining different types of basemaps.
...
```{r}
#| label: static3
#| fig-alt: Example of combining types of tiles by masking to a shapefile.
...
```{r}
#| label: osm
#| fig-alt: Example of base map using OpenStreetMap
osm_spec <- list(
  id = "OSM",
...
```{r}
#| label: thunder
#| fig-alt: Example of base map using ThunderForest
# Skip if not API KEY
