...
basemap <- esp_getTiles(madrid, "IDErioja.Claro", zoommin = 1, crop = TRUE, bbox_expand = 0)
tile_opaque <- esp_getTiles(madrid, "RedTransporte.Carreteras", transparent = FALSE, crop = TRUE, bbox_expand = 0)
...
tile_alpha <- esp_getTiles(madrid, "RedTransporte.Carreteras", transparent = TRUE, crop = TRUE, bbox_expand = 0)
