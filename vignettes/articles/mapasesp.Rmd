...
```{r}
#| label: intro
#| fig-alt: Mapa de los municipios de Galicia
library(mapSpain)
library(tidyverse)
...
```{r}
#| label: compara
#| fig-alt: Comparación de la resolución de diferentes fuentes de mapas; se muestran
#|   bordes de los datos comparados con ortofoto de la Ria de Ferrol
...
```{r}
#| label: can
#| fig-alt: Mapa de España con Canarias desplazadas
...
```{r}
#| label: 'ccaa '
#| fig-alt: 'Ejemplo: CCAA de España'
