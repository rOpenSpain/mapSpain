...
description: Learn how to include images on your maps.
knitr:
  opts_chunk:
    collapse: true
    comment: "#>"
...
```{r}
#| label: fig-static1
#| fig-cap: Map of the limits of city of Logroño using a tile as a basemap
library(mapSpain)
library(sf)
library(ggplot2)
library(tidyterra)
...
#| fig-cap: Example on how to use alpha value for combining different types of
#|   basemaps.
...
```{r}
#| label: fig-static3
#| fig-cap: Example of combining types of tiles by masking to a shapefile.
