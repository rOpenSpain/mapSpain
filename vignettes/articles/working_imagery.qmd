...
download tiles as `.png` or `.jpeg`, depending on the Web Map Service, and use
them alongside your `sf` objects.

**mapSpain** also provides a plugin for the
[**leaflet**](https://rstudio.github.io/leaflet/) R package, which lets you add
...
This example shows how to combine multiple tiles in a static map. We focus on
...
**mapSpain** provides a plugin for the **leaflet** package. Here are some quick
examples:
...
request. Below is the static URL for each provider:
