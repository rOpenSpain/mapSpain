...
description: Learn how to include imagery in your maps.
knitr:
  opts_chunk:
    collapse: true
    comment: "#>"
...
#| fig-cap: Example of using alpha values to combine different types of
#|   basemaps.
...
```{r}
#| label: fig-osm
#| fig-cap: Example of base map using OpenStreetMap
osm_spec <- list(
  id = "OSM",
...
```{r}
#| label: fig-thunder
#| fig-cap: Example of base map using ThunderForest
...
the functions above. It includes all arguments required to reproduce the API
