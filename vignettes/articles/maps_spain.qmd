...
It also supports static map tiles from WMS and WMTS services, either as
georeferenced rasters for static maps or as layers in interactive **leaflet**
maps.
...
- `esp_dict_region_code()` converts text labels into Autonomous Community or
  City and province codes. Supported coding standards are ISO2, NUTS and INE
  codes (`codauto` and `cpro`).
...
need to standardize Autonomous Community or City codes and province codes in
ISCIII COVID data.
