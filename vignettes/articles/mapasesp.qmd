...
#|   muestran bordes de los datos comparados con ortofoto de la Ria de Ferrol
...
#| label: fig-hex
#| layout-ncol: 2
#| fig-cap: Hexbin maps con mapSpain
#| fig-subcap:
#|   - Cuadrados
#|   - Hexágonos
...
Además de los mapas dinámicos, estas capas también pueden usarse como fondo en mapas estáticos.
