...
#| label: setup-cache
#| include: false
.mapspain_cache_dir <- mapSpain::esp_detect_cache_dir()
mapSpain::esp_set_cache_dir("./articles_temp", verbose = FALSE)
```
...
#| label: restore-cache
#| include: false
mapSpain::esp_set_cache_dir(.mapspain_cache_dir, verbose = FALSE)
```
