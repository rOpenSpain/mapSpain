...
train_icon <- makeIcon(
  "https://upload.wikimedia.org/wikipedia/commons/thumb/2/26/Map_icons_by_Scott_de_Jonge_-_train-station.svg/480px-Map_icons_by_Scott_de_Jonge_-_train-station.svg.png",
  "https://upload.wikimedia.org/wikipedia/commons/thumb/2/26/Map_icons_by_Scott_de_Jonge_-_train-station.svg/480px-Map_icons_by_Scott_de_Jonge_-_train-station.svg.png",
  18, 18
)
...
leaflet(stations,
  ...
  addLayersControl(
    ...
    overlayGroups = c("Carreteras", "Lineas Ferroviarias", "Estaciones"),
    options = layersControlOptions(collapsed = FALSE)
  ) %>%
  hideGroup(c("Carreteras", "Lineas Ferroviarias", "Estaciones"))
```
