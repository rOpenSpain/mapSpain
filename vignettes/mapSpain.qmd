...
**R** [**leaflet**](https://rstudio.github.io/leaflet/) map using `mapSpain::addProviderEspTiles()`.
...
This example demonstrates how **mapSpain** can be used to create thematic
maps. For plotting, we use the
