...
information about Spain at several levels.

**mapSpain** provides **sf** objects for Autonomous Communities and Cities,
provinces, municipalities and NUTS levels in Spain. It also provides hexbin
maps and other complementary geometries, such as the demarcation lines around
the Canary Islands.
...
coding standards such as NUTS, ISO2 and the INE coding system.
...
::: callout-note
When working with static map tiles, set `moveCAN = FALSE` in the `esp_get_*`
