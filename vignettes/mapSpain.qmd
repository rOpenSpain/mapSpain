...
**mapSpain** provides `sf` objects for Autonomous Communities, provinces,
municipalities and NUTS levels in Spain. It also provides hexbin maps and other
...
static map tiles as `.png` or `.jpeg`, depending on the Web Map Service, and
use them alongside your `sf` objects.
