...
**mapSpain** also includes tools to download and process static map tiles and a
[**leaflet**](https://rstudio.github.io/leaflet/) plugin for Spanish public
...
repository with multiple datasets at various resolution levels.
